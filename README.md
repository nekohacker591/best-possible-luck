...
Debug entities last for 10 seconds and then despawn automatically. Use them to quickly test hostile pathing, projectile luck, animal behavior, eye-of-ender behavior, and melee reach behavior.
