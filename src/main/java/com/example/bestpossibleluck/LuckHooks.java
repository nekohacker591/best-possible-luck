...
public final class LuckHooks {
    public enum LuckType {
        ...
        public static LuckType fromWorld(World world) {
            ...
            if (!"lucky".equalsIgnoreCase(value) && !"unlucky".equalsIgnoreCase(value)) {
                world.getGameRules().setOrCreateGameRule(BestPossibleLuckMod.LUCKTYPE_GAMERULE, "lucky");
                value = "lucky";
            }
    ...
    public static final String RULE_PLAYER_PROJECTILES = "bplPlayerProjectiles";
    public static final String RULE_HOSTILE_PATHING = "bplHostilePathing";
    public static final String RULE_ANIMAL_BEHAVIOR = "bplAnimalBehavior";
    public static final String RULE_PLAYER_MELEE = "bplPlayerMelee";
    public static final String RULE_EYE_OF_ENDER = "bplEyeOfEnder";
    public static final String RULE_FIREBALL_AIM = "bplFireballAim";
    public static final String RULE_END_CRYSTAL_BOW = "bplEndCrystalBow";
    public static final String RULE_PARKOUR_ASSIST = "bplParkourAssist";
    public static final String RULE_FISHING_HOOK_LUCK = "bplFishingHookLuck";
    public static final String RULE_HAZARD_EVASION = "bplHazardEvasion";
    public static final String RULE_FOOD_RNG = "bplFoodRng";
    public static final String RULE_DRAGON_PERCH = "bplDragonPerching";
    ...
    public static final String RULE_DIAMOND_ORE = "bplDiamondOre";
    public static final String RULE_STRUCTURE_BOOST = "bplStructureBoost";
    public static final String RULE_WHITELIST_ONLY = "bplWhitelistOnly";
    ...
    public static void ensureRules(World world) {
        ...
        ensureRule(world, RULE_HOSTILE_SPAWNS, "false", GameRules.ValueType.BOOLEAN_VALUE);
        ...
        ensureRule(world, RULE_PLAYER_PROJECTILES, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_HOSTILE_PATHING, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_ANIMAL_BEHAVIOR, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_PLAYER_MELEE, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_EYE_OF_ENDER, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_FIREBALL_AIM, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_END_CRYSTAL_BOW, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_PARKOUR_ASSIST, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_FISHING_HOOK_LUCK, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_HAZARD_EVASION, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_FOOD_RNG, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_DRAGON_PERCH, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ...
        ensureRule(world, RULE_DIAMOND_ORE, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_STRUCTURE_BOOST, "true", GameRules.ValueType.BOOLEAN_VALUE);
        ensureRule(world, RULE_WHITELIST_ONLY, "false", GameRules.ValueType.BOOLEAN_VALUE);
    }
    ...
    public static boolean isPersonalLuckEnabled(EntityPlayer player) {
        if (player == null) {
            return false;
        }
        World world = player.world;
        if (!isEnabled(world, RULE_WHITELIST_ONLY)) {
            return true;
        }
        ...
        return playerList != null && playerList.canJoin(player.getGameProfile());
    }
    ...
    public static void applySpiderBias(EntityLivingBase spider, LuckType luckType) {
        if (luckType == LuckType.LUCKY) {
            for (PotionEffect effect : new ArrayList<PotionEffect>(spider.getActivePotionEffects())) {
